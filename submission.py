...
def deploy(img_path):
    ...
    net = caffe.Classifier('/dli/data/digits/20200524-194844-dcec/deploy.prototxt', '/dli/data/digits/20200524-194844-dcec/snapshot_iter_108.caffemodel',
                           channel_swap=(2,1,0),
                           raw_scale=255,
                           image_dims=(256, 256))
    ...
    mean_image = caffe.io.load_image('/dli/data/digits/20200524-194515-9305/mean.jpg')
